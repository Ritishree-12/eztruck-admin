...
import OfflineBH from "./OfflineBH";
...
const BookingOffline = () => {
  ...
  //   customerPaymentStatus: "Customer Payment Share",
  //   customerPaid: "Customer Paid",
  //   customerPendingPayment: "Customer Pending Payment",
  //   driverPaymentStatus: "Driver Payment Share",
  //   driverPaid: "Driver Paid",
  //   driverPendingPayment: "Driver Pending Payment",
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <div className="row">
                  <div className="col">
                    <h4 className="card-title  float-left">Offline Booking History</h4>
                  </div>
                  <div
                    className="col"
